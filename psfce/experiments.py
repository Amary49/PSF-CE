...
from .models import (run_psfce,run_ca,run_poly2,run_dckl,run_old_sacsi,
...
def _dispatch(family,y,parts,c,method,params,options,rounding=None):
    ...
    if method=="DCKL": return run_dckl(family,c,float(params.get("alpha",0.1)),seed,rounding,n_init)
    if method=="SA-CSI": return run_old_sacsi(family,c,float(params.get("lambda",1.0)),float(params.get("gamma",4.0)),seed,rounding,n_init)
